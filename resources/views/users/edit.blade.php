...
<div class="row page-titles mx-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit User - {{ $user->name }}</a></li>
    </ol>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="roles[]" id="roles" multiple class="form-control select2" required>
                                    ...
                                    <option value="{{ $value->id }}" {{ in_array($value->name, $userRole) ? 'selected' : '' }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                            </div>
